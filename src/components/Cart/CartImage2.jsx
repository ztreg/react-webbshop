...
export default function CartImage2() {
  return (
    <>
      <svg width="2em" height="3em" viewBox="0 0 16 16" className="bi bi-cart-plus-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
